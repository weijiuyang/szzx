...
```json
{
  ...
  "history": [
    ...
    },
    {
      "version": "0.2.10",
      "date": "2026-07-10",
      "notes": "修复日报流刷新后旧高度计算回调访问已删除卡片导致的 PySide 报错。"
    },
    {
      "version": "0.2.9",
      "date": "2026-07-10",
      "notes": "收紧项目页日报流高度计算，卡片按实际文字行数自适应，减少多余空白。"
    },
    {
      "version": "0.2.8",
      "date": "2026-07-10",
      "notes": "优化项目页日报流留白，增加日报卡片之间和组内多条日报之间的上下间距。"
    },
    {
      "version": "0.2.7",
      "date": "2026-07-10",
      "notes": "新增项目加入提醒：被拉进项目后桌宠会提示项目名称和当前身份。"
    },
    {
      "version": "0.2.6",
      "date": "2026-07-10",
      "notes": "修复项目页日报流长内容显示不全的问题，日报卡片会按实际文本高度自适应。"
    },
    {
      "version": "0.2.5",
      "date": "2026-07-10",
